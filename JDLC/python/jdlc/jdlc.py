...
if __name__ == '__main__':
    ...
    parser.add_argument('-st', '--storagetype', metavar = 'StorageType', type = str, help = 'Type of storage for inserted table corpus (\'NATIVE\', \'HDFS\')', choices = ['NATIVE', 'HDFS'], required = False, default = 'NATIVE')
